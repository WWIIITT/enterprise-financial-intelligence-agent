...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="glossary" tabindex="-1">Glossary <a class="header-anchor" href="#glossary" aria-label="Permalink to &quot;Glossary&quot;">​</a></h1><table tabindex="0"><thead><tr><th>Term</th><th>Meaning</th></tr></thead><tbody><tr><td>RAG</td><td>Retrieval-Augmented Generation</td></tr><tr><td>Qdrant</td><td>Vector database used for semantic retrieval</td></tr><tr><td>SEC EDGAR</td><td>Public SEC filing system</td></tr><tr><td>FRED</td><td>Federal Reserve Economic Data</td></tr><tr><td>Company Facts</td><td>SEC XBRL structured company data</td></tr><tr><td>LangGraph</td><td>Workflow framework used for agent routing</td></tr><tr><td>Guardrail</td><td>Preflight rule that masks, blocks, or allows a request</td></tr><tr><td>Evaluation suite</td><td>Group of deterministic test cases</td></tr><tr><td>Citation score</td><td>Evaluation measure for required citation terms</td></tr><tr><td>Source coverage</td><td>Evaluation measure for expected source availability</td></tr><tr><td>P95 latency</td><td>95th percentile latency</td></tr><tr><td>Cosine similarity</td><td>Similarity score computed from vector dot product divided by vector magnitudes</td></tr><tr><td>Top-k retrieval</td><td>Returning the k highest-scoring retrieved chunks</td></tr><tr><td>Route accuracy</td><td>Share of cases where the selected agent matches the expected agent</td></tr><tr><td>Pass rate</td><td>Cases passed divided by total cases</td></tr><tr><td>Hallucination proxy</td><td>Deterministic warning signal based on missing required evidence or forbidden terms</td></tr><tr><td>No-answer threshold</td><td>Minimum evidence quality required before the system answers</td></tr><tr><td>Route share</td><td>Count of requests for one agent divided by total request count</td></tr></tbody></table></div>`);
}
